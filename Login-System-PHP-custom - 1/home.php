          ...
          <header id="header" class="header sticky-top">
               ...
               <div class="topbar d-flex align-items-center">
                    <div class="container d-flex justify-content-center justify-content-md-between">
                         ...
                         <div class="social-links  d-md-flex align-items-center justify-content-center text-center"> <!-- d-none -->
                              <!--   <a href="index.php" class="border-bottom p-1 "><i class="fa-regular fa-user pe-1"></i>Login</a> -->

                              <?php
                              // Check if the user is logged in
                              if (isset($_SESSION['user_name'])) {
                                   echo '<p class=" text-white pt-3 text-center">Hello, ' . htmlspecialchars($_SESSION['user_name']) . '!</p>';
