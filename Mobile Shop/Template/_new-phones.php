...
?>
<section id="new-phones" class="padding-bottom">
    <div class="container">
                            ...
                            <form method="post">
                              ...
                              <?php
                               ...
                               if(in_array($item['item_id'], $Cart->getCartId($product->getData('cart'))) ?? []){
                                ...
                                echo '  <button type="submit" name="new_phones_submit" class="btn btn-success font-size-12 ">In the Cart</button>';
                               } else {
