...
if(isset($_POST['password-reset-token']) && $_POST['user_email'])
{
  ...
  if($row)
  {
    ...
    $link = "
    <a href='http://localhost/beginers/Login%20training/Log-in-No-talking/github-password-reset/password_reset-main/reset-password.php?key=".$emailId."&token=".$token."'>
