...
if(strlen($_POST["password"]) < 8) {
    die("Passwordmust be at least 8 characters");
}
...
if ($_POST["password"] !== $_POST["password_confirmation"]) {
    die("Password must mach");
}

$password_hash = password_hash($_POST["password"], PASSWORD_DEFAULT);


$sql = "UPDATE users1 SET password= ?, reset_token_hash = NULL, reset_token_expires_at = NULL WHERE id =?";
