...
if (
	...
	if (empty($uname. $pass. $email. $re_pass)) {
		header("Location: index.php?error=Fill in Create Account blank");
		exit();
	}
	...
	//това е за ако паролите не си съответстват да дава грешка
        ...
        //The email is taken try another
           ...
           $sql2 = "INSERT INTO users1(user_name, email, password, name,verify_token) VALUES('$uname', '$email', '$pass', '$name','$verify_token')";
		   $result2 = mysqli_query($conn, $sql2);
